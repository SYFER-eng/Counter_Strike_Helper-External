...
inline void cs2::features::update_settings(void)
{
	...
	{
	default:
		config::aimbot_button = 318; //aim button
		config::triggerbot_button = 299; //trigger button
		config::aimbot_fov = 14.0f; //how far the target is from the cross hair for the aimbot to lock on
		config::aimbot_smooth = 0.1f; //smothness of the aimbot
		config::visuals_enabled = 1; //some times workes
		break;
	}
}
